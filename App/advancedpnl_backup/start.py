...
from App.advancedpnl_backup.websocket import MarkPriceWebSocket
from App.advancedpnl_backup.userstream import UserDataStream
from App.advancedpnl_backup.tradingpairs import trading_pairs
from App.advancedpnl_backup.strategy import AdvancedPnlStrategy
...
log_file = Path(__file__).parent / 'advancedpnl_backup.log'
