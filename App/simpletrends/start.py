...
async def main():
    ...
    redis_client = redis.Redis(host=redis_host, port=6379, db=4, decode_responses=True)
    ...
    ws = MarkPriceWebSocket(symbol_list, redis_host=redis_host, redis_port=6379, redis_db=4)
